...
int main (int argc, char **argv)
{
	...
	if (argc==4) {
		...
		printf("Usage:\n$ sudo ./monitorCountsAndCurrentDigital <cycles> <measurementsPerCycle> <comments>\n");
		return 0;
	}
	...
	strftime(fileName,BUFSIZE,"/home/pi/RbData/%F/countsAndCurrent%F_%H%M%S.dat",timeinfo);
