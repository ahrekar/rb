...
int main (int argc, char **argv)
{
	...
	setProbeDetuning(PROBEDETUNING);
...
void collectAndRecordData(char* fileName, float* maxes, float* mins, int* channels, int numChannels){
	...
	//while(returnFloat!=0){
		...
		delay(1000);
		//scanf("%f",&returnFloat);
		kensWaveLength = getPumpFrequency(&returnFloat);// Getting the wavelength invokes a significant delay
