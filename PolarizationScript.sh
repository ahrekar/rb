...
# Usage:
#
#		sudo ./PolarizationScript <aout background> <aout Helium Excited> <additional comments>
#

if [ "$#" -ne 9 ]; then
	echo "usage: sudo ./PolarizationScript.sh <aout start> <aout end> <step size> <RbScan start> <RbScan end> <aout background> <aout Helium Excited> <dwell> <additional comments>"
