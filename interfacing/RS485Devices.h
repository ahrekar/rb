...
int listenGPIBData(unsigned char *returnData, char terminator, char gpibaddress, unsigned short Address); // Ken's original line.
//int listenGPIBData(char *returnData, char terminator, char gpibaddress, unsigned short Address); // Karl used this for a period so warnings would be avoided at compile.
