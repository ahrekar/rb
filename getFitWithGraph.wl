faradayData=Import["/home/pi/RbData/2016-08-10/FDayScan2016-08-10_121750.dat","Data"]
...
graph=Show[ListPlot[faradayData],Plot[modelResult[detune],{detune,First[faradayData][[1]]*aoutConv+aoutIntercept+vo,Last[faradayData][[1]]*aoutConv+aoutIntercept+vo}],Frame-> True];
Export["test.jpg",graph]
